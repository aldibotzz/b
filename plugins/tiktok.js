...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    let res = (await axios.get(`https://api.malesin.xyz/tiktok?url=${args[0]}&apikey=DonasiDong`)).data
...
await conn.sendFile(m.chat, json.noWatermark, 'video.mp4', ` Nih Jangan Spam Ya\n Reply Video Ini dengan caption #tomp3 untuk convert to mp3
`, m, false, { //contextInfo: { forwardingScore: 999, isForwarded: true }})
})
}
